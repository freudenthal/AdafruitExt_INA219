...
#ifndef _LIB_ADAFRUITEXT_INA219_
#define _LIB_ADAFRUITEXT_INA219_
 ...
 */
class AdafruitExt_INA219 {
public:
  AdafruitExt_INA219(uint8_t addr = INA219_ADDRESS);
  ~AdafruitExt_INA219();
  ...
  bool lastBusVoltageReadingWasNew();
  bool lastBusVoltageReadingHadOverflow();
...
private:
  ...
  bool lastBusVoltageNew;
  bool lastReadOverflow;
